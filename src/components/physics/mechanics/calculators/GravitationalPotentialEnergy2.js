...
const GravitationalPotentialEnergy2 = () => {
  ...
  const variableName4 = 'Distance between Centers of the Masses';
  const um1 = 'N·m²/kg²';
  const um2 = 'kg';
  const um3 = 'm';
  const solutionUM = 'J';
  ...
  const onSolveHandler = () => {
    const solution = new mechanics().gravitationalPotentialEnergy2(
...
export default GravitationalPotentialEnergy2;
