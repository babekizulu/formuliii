...
const OperatingExpenses = () => {
  ...
  //variables
  const variableName1 = 'Marketing Expense';
  const variableName2 = 'Distribution Expense';
  const variableName3 = 'Administrative Expense';
  ...
  const onSolveHandler = () => {
    const solution = new incomeStatement().operatingExpenses(
      marketingExpense,
      distributionExpense,
  ...
  return (
    <div className='calculator'>
      ...
      />
      <Input
        stateValue={distributionExpense}
        onChangeHandler={onChangeHandler}
        um={currency}
        name={variableName2}
        type={type}
      />
      <Input
        stateValue={administrativeExpense}
        onChangeHandler={onChangeHandler}
        um={currency}
        name={variableName3}
        type={type}
