...
const {earningsBTFormula} = new IncomeStatementFormulae();

const EarningsBTCalculator = () => {
    //state
    ...
    const vname2 = 'Interest Expense';
    const subjectTag = 'financial';
    //array
    const inputNamesArr = [
        vname1,
        vname2
    ...
    const onChangeHandler = (variableName, value) => {
        ...
        if(variableName === vname2) {
            setInterestExpense(value);
        };
    };
    const solutionHandler = () => {
        const solution = earningsBTFormula(operatingIncome, interestExpense);
...
export default EarningsBTCalculator;