...
const {earningsBITFormula} = new IncomeStatementFormulae();

const EarningsBITCalculator = () => {
    ...
    const vname1 = 'Gross Profit';
    const vname2 = 'Operating Expenses';
    ...
    const solutionHandler = () => {
        const solution = earningsBITFormula(grossProfit, operatingExpenses);
...
export default EarningsBITCalculator;
