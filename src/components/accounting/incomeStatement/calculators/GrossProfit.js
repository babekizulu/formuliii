...
const GrossProfit = () => {
  ...
  //variables
  const variableName1 = 'Sales Revenue';
  const variableName2 = 'Cost of Production';
  ...
  const onSolveHandler = () => {
    const solution = new incomeStatement().grossProfit(
      salesRevenue,
      costOfProduction,
    );
