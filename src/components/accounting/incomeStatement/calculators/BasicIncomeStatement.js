...
const BasicIncomeStatement = () => {
  ...
  //variables
  const variableName1 = 'Sales';
  const variableName2 = 'Expenses';
  ...
  const onSolveHandler = () => {
    const solution = new incomeStatement().basic(sales, expenses);
...
export default BasicIncomeStatement;
