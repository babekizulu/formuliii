...
const DebtCapital = () => {
  ...
  //variables
  const variableName1 = 'Current Debt';
  const variableName2 = 'Long-Term Debt';
  ...
  const onSolveHandler = () => {
    const solution = new balanceSheet().debtCapital(currentDebt, longTermDebt);
