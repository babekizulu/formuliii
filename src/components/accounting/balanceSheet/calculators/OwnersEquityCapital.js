...
const OwnersEquityCapital = () => {
  ...
  //variables
  const variableName1 = 'Owners Net-Worth';
  const variableName2 = 'Partnership Equity';
  const variableName3 = 'Common Stock Equity';
  ...
  const onSolveHandler = () => {
    const solution = new balanceSheet().ownersEquityCapital(
      ownersNetWorth,
      partnershipEquity,
      commonStockEquity,
    );
...
export default OwnersEquityCapital;
