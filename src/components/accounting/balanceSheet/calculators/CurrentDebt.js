...
const CurrentDebt = () => {
  ...
  //variables
  const variableName1 = 'Accounts Payable';
  const variableName2 = 'Other Payables';
  const variableName3 = 'Accrued Expenses';
  const variableName4 = 'Short-Term Notes';
