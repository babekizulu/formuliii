...
const FixedAssets = () => {
  ...
  //variables
  const variableName1 = 'Machinery & Equipment';
  const variableName2 = 'Buildings';
  const variableName3 = 'Land';
  ...
  const onChangeHandler = (variableName, value) => {
    if (variableName === variableName1) {
      setMachineryAndEquipment(value);
    }
  ...
  const onSolveHandler = () => {
    const solution = new balanceSheet().fixedAssets(
  ...
  return (
    <div className='calculator'>
      ...
      <Input
        stateValue={machineryAndEquipment}
