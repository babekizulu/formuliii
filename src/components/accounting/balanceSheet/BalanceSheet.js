...
const BalanceSheet = () => {
  return (
    <div className='menu'>
      ...
      <Link href='/accounting/balance-sheet/current-debt' className='menu-item'>
        Current Debt Calculator
      </Link>
      <Link href='/accounting/balance-sheet/debt-capital' className='menu-item'>
        Debt Capital Calculator
      </Link>
      <Link href='/accounting/balance-sheet/fixed-assets' className='menu-item'>
      ...
      <Link href='/accounting/balance-sheet/other-assets' className='menu-item'>
      ...
      <Link href='/accounting/balance-sheet/total-assets' className='menu-item'>
