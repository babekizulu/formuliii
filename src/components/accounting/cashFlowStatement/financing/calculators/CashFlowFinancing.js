...
const CashFlowFinancing = () => {
  ...
  //variables
  const variableName1 = 'Interest Payments';
  const variableName2 = 'Change In Debt Principal';
  const variableName3 = 'Dividends Paid';
  const variableName4 = 'Change in Stock';
  ...
  const onSolveHandler = () => {
    const solution = new cashFlowStatement().financing(
      interestPayments,
  ...
  return (
    <div className='calculator'>
      ...
      />
      <Input
        stateValue={changeInDebtPrincipal}
        onChangeHandler={onChangeHandler}
        um={currency}
        name={variableName2}
        type={type}
...
export default CashFlowFinancing;
