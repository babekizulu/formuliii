...
const ATCFO = () => {
  ...
  const [
    ...
    setEarningsBeforeIncomeTaxesDepreciationAndAmortization,
  ] = useState('');
  const [cashTaxPayments, setCashTaxPayments] = useState('');
  const [currency, setCurrency] = useState('ZAR');
  const [solution, setSolution] = useState(0);
  //variables
  const variableName1 =
    'Earnings before Income, Taxes, Depreciation & Amortization';
  const variableName2 = 'Cash Tax Payments';
  ...
  const onChangeHandler = (variableName, value) => {
    if (variableName === variableName1) {
      setEarningsBeforeIncomeTaxesDepreciationAndAmortization(value);
    }
    if (variableName === variableName2) {
      setCashTaxPayments(value);
    }
  };
  const onACHandler = () => {
    setEarningsBeforeIncomeTaxesDepreciationAndAmortization('');
  ...
  return (
    <div className='calculator'>
      ...
      <Input
        stateValue={earningsBeforeIncomeTaxesDepreciationAndAmortization}
