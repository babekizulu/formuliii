...
const DeltaLTA = () => {
  ...
  const [grossPurchasePriceOfFixedAssets, setGrossPurchasePriceOfFixedAssets] =
    useState('');
  const [netCashUsedForInvestments, setNetCashUsedForInvestments] =
    useState('');
  const [currency, setCurrency] = useState('ZAR');
  const [solution, setSolution] = useState(0);
  //variables
  const variableName1 = 'Gross Purchase Price of Fixed Assets';
  const variableName2 = 'Net Cash used for Investments';
  ...
  const onChangeHandler = (variableName, value) => {
    if (variableName === variableName1) {
      setGrossPurchasePriceOfFixedAssets(value);
    }
    if (variableName === variableName2) {
      setNetCashUsedForInvestments(value);
    }
  };
  const onACHandler = () => {
  ...
  const onSolveHandler = () => {
    const solution = new cashFlowStatement()
      .firmCashFlow()
      .deltaLTA(grossPurchasePriceOfFixedAssets, netCashUsedForInvestments);
  ...
  return (
    <div className='calculator'>
      ...
      <Input
        stateValue={grossPurchasePriceOfFixedAssets}
      ...
      />
      <Input
        stateValue={netCashUsedForInvestments}
        onChangeHandler={onChangeHandler}
        um={currency}
        name={variableName2}
        type={type}
