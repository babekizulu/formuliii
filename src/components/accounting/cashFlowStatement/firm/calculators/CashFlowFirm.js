...
const CashFlowFirm = () => {
  ...
  const [afterTaxCashFlows, setAfterTaxCashFlows] = useState('');
  const [
    investmentInNetOperatingWorkingCapital,
    setInvestmentInNetOperatingWorkingCapital,
  ] = useState('');
  const [
    investmentInFixedAssetsAndOtherAssets,
    setInvestmentInFixedAssetsAndOtherAssets,
  ] = useState('');
  const [currency, setCurrency] = useState('ZAR');
  const [solution, setSolution] = useState(0);
  //variables
  const variableName1 = 'After-Tax Cash Flows';
  const variableName2 = 'Investment in Net Operating Working Capital';
  const variableName3 = 'Investment in Fixed Assets & Other Assets';
  ...
  const onChangeHandler = (variableName, value) => {
    if (variableName === variableName1) {
      setAfterTaxCashFlows(value);
    }
    if (variableName === variableName2) {
      setInvestmentInNetOperatingWorkingCapital(value);
    }
    if (variableName === variableName3) {
      setInvestmentInFixedAssetsAndOtherAssets(value);
    }
  };
  const onACHandler = () => {
  ...
  return (
    <div className='calculator'>
      ...
      />
      <Input
        stateValue={investmentInNetOperatingWorkingCapital}
        onChangeHandler={onChangeHandler}
        um={currency}
        name={variableName2}
        type={type}
      />
      <Input
        stateValue={investmentInFixedAssetsAndOtherAssets}
        onChangeHandler={onChangeHandler}
        um={currency}
        name={variableName3}
        type={type}
