...
const {deltaLTAFormula} = new FirmCashFlowStatementFormulae();

const ChangeInLTA = () => {
    //state
    const [selected, setSelected] = useState('rand');
    const [grossPurchasePriceOfFixedAssets, setGrossPurchasePriceOfFixedAssets] = useState('');
    const [netCashUsedForInvestments, setNetCashUsedForInvestments] = useState('');
    const [solution, setSolution] = useState(0);
    const [solutionUM, setSolutionUM] = useState('ZAR');
    //vnames & subject tag
    const vname1 = 'Gross Purchase Price of Fixed Assets';
    const vname2 = 'Net Cash Used for Investments';
    ...
    const solutionHandler = () => {
        const solution = deltaLTAFormula(
            grossPurchasePriceOfFixedAssets,
            netCashUsedForInvestments
        );
