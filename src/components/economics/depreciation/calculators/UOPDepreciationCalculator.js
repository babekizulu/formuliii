...
import { UnitsOfProductionDepreciationFormula } from '../../../../libs/EconomicsFormulae';
//components
import BackBtn from '../../../BackBtn';
import CurrencySelector from '../../../CurrencySelector';
import Calculator from '../../../CalculatorParts/Calculator';
//destructured formula
const {solve} = new UnitsOfProductionDepreciationFormula();

const UOPDepreciationCalculator = () => {
    //state
    const [selected, setSelected] = useState('rand');
    const [numberOfUnitsProduced, setNumberOfUnitsProduced] = useState('');
    ...
    const onChangeHandler = (variableName, value) => {
        if(variableName === vname1) {
            setNumberOfUnitsProduced(value);
        };
...
export default UOPDepreciationCalculator;