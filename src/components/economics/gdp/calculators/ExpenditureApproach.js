...
const ExpenditureApproach = () => {
  ...
  //variables
  const variableName1 = 'Consumption';
  const variableName2 = 'Investment';
  const variableName3 = 'Government Expenditure';
  const variableName4 = 'Net Exports';
  ...
  const onSolveHandler = () => {
    const solution = new gdp().expenditureApproach(
      consumption,
      investment,
  ...
  return (
    <div className='calculator'>
      ...
      />
      <Input
        stateValue={governmentExpenditure}
        onChangeHandler={onChangeHandler}
        um={currency}
        name={variableName3}
        type={type}
...
export default ExpenditureApproach;
